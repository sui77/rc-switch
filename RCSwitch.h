...
#define RCSWITCH_PROTOCOL_1 1
#define RCSWITCH_PROTOCOL_2 2
#define RCSWITCH_PROTOCOL_3 3
#define RCSWITCH_PROTOCOL_4 4
#define RCSWITCH_PROTOCOL_5 5
...
class RCSwitch {
  ...
  private:
    ...
    static unsigned int enabledProtocols;
